...
public class JamDriver2_2511533006 {
	...
	public static void main(String[] args) {
        ...
        // 1. Input Jam Pertama
        System.out.println("\n--- Input Jam 1 ---");
        Jam_2511533006 j1 = buatJamDariInput(input);
        // 2. Input Jam Kedua
        System.out.println("\n--- Input Jam 2 ---");
        Jam_2511533006 j2 = buatJamDariInput(input);
        // 3. Menampilkan Data
        System.out.println("\n--- Hasil Operasi ---");
        ...
        System.out.println("Durasi (J1 ke J2) : " + Jam_2511533006.durasiDetik(j1, j2) + " detik");

        Jam_2511533006 jNext = j1.nextSecond();
        System.out.println("Jam 1 detik berikutnya: " + jNext);

        Jam_2511533006 jPrev = j2.previousSecond();
        System.out.println("Jam 1 detik sebelumnya: " + jPrev);
        // 6. Operasi Penjumlahan Jam
        Jam_2511533006 jHasilPlus = j1.plus(j2);
     ...
     */
    private static Jam_2511533006 buatJamDariInput(Scanner sc) {
        int h, m, s;
        while (true) {
            ...
            if (Jam_2511533006.isValid(h, m, s)) {
